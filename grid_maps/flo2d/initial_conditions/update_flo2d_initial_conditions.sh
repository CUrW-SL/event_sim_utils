...
echo "Running update_flo2d_initial_conditions.py"
python grid_maps/flo2d/initial_conditions/update_flo2d_initial_conditions.py >> grid_maps/flo2d/initial_conditions/curw_sim_update_flo2d_initial_cond.log 2>&1
